...
const MyBookingsScreen = ({ navigation }) => {
    ...
    try {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          // Fetch play details for each booking that has playId
            ...
            bookingsData.map(async (booking) => {
              if (booking.playId && !booking.play) {
                ...
                if (playDetails) {
                  ...
                  // Set default play object if fetch fails
                  booking.play = {
        ...
        try {
          ...
          if (testResponse.data.success) {
            ...
            // Fetch play details for fallback bookings
            const bookingsWithDetails = await Promise.all(
  ...
  const getStatusIcon = (status) => {
    ...
    if (['approved', 'confirmed', 'checked_in'].includes(statusLower)) return 'checkmark-circle';
    if (['rejected', 'cancelled'].includes(statusLower)) return 'close-circle';
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          {playImage ? (
            ...
            <View style={[styles.playImage, styles.noImage]}>
        ...
        <View style={styles.cardBody}>
          ...
          <View style={styles.detailsGrid}>
            <View style={styles.detailItem}>
              ...
              <Text style={styles.detailValue}>{formatShortDate(item.playDate)}</Text>
            </View>
            <View style={styles.detailItem}>
              <Ionicons name="ticket-outline" size={16} color="#666" />
              <Text style={styles.detailLabel}>Tickets</Text>
              <Text style={styles.detailValue}>{item.quantity} × {item.ticketType?.toUpperCase() || 'REGULAR'}</Text>
            </View>
            <View style={styles.detailItem}>
              <Ionicons name="person-outline" size={16} color="#666" />
              <Text style={styles.detailLabel}>Seats</Text>
              <Text style={styles.detailValue} numberOfLines={1}>{getSeatNumbers(item.allocatedSeats)}</Text>
            </View>
            <View style={styles.detailItem}>
              <Ionicons name="cash-outline" size={16} color="#666" />
              <Text style={styles.detailLabel}>Total</Text>
              <Text style={styles.detailValue}>KES {item.totalPrice || 0}</Text>
            </View>
          </View>
          ...
          {item.bookingReference && (
            <View style={styles.referenceRow}>
              ...
              <Text style={styles.referenceText}>Ref: {item.bookingReference}</Text>
            </View>
          )}
          ...
          {item.status?.toLowerCase() === 'checked_in' && (
            <View style={[styles.infoRow, { backgroundColor: '#E8F5E9' }]}>
          ...
          <View style={styles.actionButtons}>
            {canCancel && (
              <TouchableOpacity 
                ...
                onPress={() => handleCancelBooking(item.id || item._id, item.playTitle)}
              >
          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
              <View style={styles.modalPlayInfo}>
                {playImage ? (
                  <Image source={{ uri: playImage }} style={styles.modalPlayImage} />
                ) : (
                  <View style={[styles.modalPlayImage, styles.modalNoImage]}>
                ...
                <View style={styles.modalPlayDetails}>
                  ...
                  <Text style={styles.modalPlayVenue}>{venue}</Text>
              ...
              <View style={styles.modalSection}>
                ...
                <View style={styles.modalDetailRow}>
                  <View style={styles.modalDetailItem}>
                    ...
                    <Text style={styles.modalDetailValue}>{formatDate(selectedBooking.playDate)}</Text>
                  </View>
                  <View style={styles.modalDetailItem}>
                ...
                <View style={styles.modalDetailRow}>
                  <View style={styles.modalDetailItem}>
                    <Ionicons name="ticket" size={18} color="#6200EE" />
                    <Text style={styles.modalDetailLabel}>Ticket Type</Text>
                    <Text style={styles.modalDetailValue}>{selectedBooking.ticketType?.toUpperCase()}</Text>
                  </View>
                  <View style={styles.modalDetailItem}>
                    <Ionicons name="people" size={18} color="#6200EE" />
                    <Text style={styles.modalDetailLabel}>Quantity</Text>
                    <Text style={styles.modalDetailValue}>{selectedBooking.quantity} ticket(s)</Text>
                  </View>
                </View>
                
                <View style={styles.modalDetailItem}>
                  <Ionicons name="person" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Seats</Text>
                  <Text style={styles.modalDetailValue}>{seatNumbers}</Text>
                </View>
                
                <View style={styles.modalDetailItem}>
                  <Ionicons name="cash" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Total Amount</Text>
                  <Text style={[styles.modalDetailValue, styles.modalTotalPrice]}>
                    KES {selectedBooking.totalPrice}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.modalSection}>
                ...
                <View style={styles.modalDetailItem}>
                  <Ionicons name="card" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Payment Method</Text>
                  <Text style={styles.modalDetailValue}>
                    {selectedBooking.paymentMethod?.toUpperCase() || 'N/A'}
                  </Text>
                </View>
                
                <View style={styles.modalDetailItem}>
                  <Ionicons name="document-text" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Payment Code</Text>
                  <Text style={styles.modalDetailValue}>
                    {selectedBooking.paymentCode || 'N/A'}
                  </Text>
                </View>
                
                <View style={styles.modalDetailItem}>
                  <Ionicons name="barcode" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Booking Reference</Text>
                  <Text style={styles.modalDetailValue}>
              ...
              <View style={styles.modalSection}>
                ...
                <View style={styles.modalDetailItem}>
                  <Ionicons name="person-circle" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Name</Text>
                  <Text style={styles.modalDetailValue}>
                    {selectedBooking.customerName || userData?.fullName}
                  </Text>
                </View>
                
                <View style={styles.modalDetailItem}>
                  <Ionicons name="mail" size={18} color="#6200EE" />
                  <Text style={styles.modalDetailLabel}>Email</Text>
                  <Text style={styles.modalDetailValue}>
                    {selectedBooking.customerEmail || userData?.email}
                  </Text>
                </View>
                ...
                <View style={styles.modalDetailItem}>
                  ...
                  <Text style={styles.modalDetailValue}>
                    {selectedBooking.customerPhone || userData?.phone || 'Not provided'}
                  </Text>
                </View>
              </View>
            </ScrollView>
              ...
              >
                {generatingTicket ? (
                  ...
                  <>
                    ...
                    <Text style={styles.modalTicketButtonText}>
  ...
  const renderEmptyState = () => (
    <ScrollView contentContainerStyle={styles.emptyContainer} showsVerticalScrollIndicator={false}>
      <View style={styles.emptyIllustration}>
        <Ionicons name="ticket-outline" size={100} color="#e0e0e0" />
      </View>
      ...
      >
        ...
        <Text style={styles.exploreButtonText}>Explore Plays</Text>
      </TouchableOpacity>
      <TouchableOpacity 
        style={styles.secondaryButton} 
        onPress={onRefresh}
      >
        <Ionicons name="refresh" size={20} color="#6200EE" style={styles.refreshIcon} />
  ...
  if (!userData) {
    return (
      <View style={styles.centered}>
        ...
        <Text style={styles.loginSubText}>Please login to view your bookings</Text>
        <TouchableOpacity 
      ...
      <View style={styles.statsBar}>
        ...
        <View style={styles.statItem}>
          <Text style={[styles.statNumber, { color: '#4CAF50' }]}>
            {filteredBookings.filter(b => isTicketAvailable(b)).length}
          </Text>
          <Text style={styles.statLabel}>Ready for Ticket</Text>
        </View>
        <View style={styles.statDivider} />
        <View style={styles.statItem}>
